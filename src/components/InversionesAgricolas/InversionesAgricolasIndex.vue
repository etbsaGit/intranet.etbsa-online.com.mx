<template>
  ...
  <BaseDialog v-model="showAdd" mode="create" @submit="postItem">
    <template #form>
      <inversiones-agricolas-form ref="add" :cliente="cliente" />
    </template>
  </BaseDialog>

  <BaseDialog v-model="showEdit" mode="edit" @submit="putItem">
    <template #form>
      <inversiones-agricolas-form ref="edit" :inversion="selectedItem" />
    </template>
  </BaseDialog>
...
import InversionesAgricolasForm from "src/components/InversionesAgricolas/InversionesAgricolasForm.vue";
...
const baseURL = ref("/api/intranet/inversionesAgricola");
