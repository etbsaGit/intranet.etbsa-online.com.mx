...
const getRows = async () => {
  let res = await sendRequest("GET", null, "/api/intranet/classification", "");
  rows.value = res;
};
...
const postItem = async () => {
  ...
  const final = {
    ...add.value.formClassification,
  };
  let res = await sendRequest(
    "POST",
    final,
    "/api/intranet/classification",
    ""
  );
  showAdd.value = false;
  getRows();
...
const putItem = async () => {
  ...
  const final = {
    ...edit.value.formClassification,
  };
  let res = await sendRequest(
    "PUT",
    final,
    "/api/intranet/classification/" + final.id,
    ""
  );
...
const destroyItem = async () => {
  let res = await sendRequest(
    "DELETE",
    null,
    "/api/intranet/classification/" + selectedItem.value.id,
    ""
  );
