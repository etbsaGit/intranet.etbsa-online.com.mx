...
const BASE_URL = "/api/intranet/riego"; // singular para post/put/delete
...
const updateItem = async (item) => {
  ...
  const data = { ...edit.value.formRiego, id: item.id };
