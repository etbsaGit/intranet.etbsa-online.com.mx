...
const getRows = async () => {
  let res = await sendRequest(
    "GET",
    null,
    "/api/intranet/technological-capability",
    ""
  );
  rows.value = res;
};
...
const putItem = async () => {
  ...
  const final = {
    ...edit.value.formCapTec,
  };
  let res = await sendRequest(
    "PUT",
    final,
    "/api/intranet/technological-capability/" + final.id,
    ""
  );
...
const destroyItem = async () => {
  let res = await sendRequest(
    "DELETE",
    null,
    "/api/intranet/technological-capability/" + selectedItem.value.id,
    ""
  );
