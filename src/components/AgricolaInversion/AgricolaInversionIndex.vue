<template>
  ...
  <BaseList
    ...
    :headers="[
      ...
      { label: '# de hectareas', key: 'hectareas' },
      { label: 'Cultivo', key: 'cultivo', slot: 'cultivo' },
      { label: 'Costo p/ hectarea', key: 'costo', slot: 'costo' },
      { label: 'Total', key: 'total', slot: 'total' },
      { label: 'Rendimiento toneladas p/hectarea', key: 'toneladas' },
      { label: 'Precio p/ tonelada', key: 'precio', slot: 'precio' },
      { label: 'Ingreso total', key: 'ingreso', slot: 'ingreso' },
      { label: 'Utilidad del cultivo', key: 'utilidad', slot: 'utilidad' },
    ]"
    :labelAdd="'Ingresar inversion agricola'"
    :onAdd="openCreate"
  >
    <template #edit="{ item }">
      <q-btn
  ...
  <q-item v-if="crud.items.totales">
    <q-item-section align="right">
      <agricola-inversion-total-card :datos="crud.items.totales" />
    </q-item-section>
  </q-item>
...
import AgricolaInversionForm from "src/components/AgricolaInversion/AgricolaInversionForm.vue";
import AgricolaInversionTotalCard from "src/components/AgricolaInversion/AgricolaInversionTotalCard.vue";
...
const baseURL = ref("/api/intranet/agricolaInversion");
